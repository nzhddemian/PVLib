...
#ifndef PVLIB_SWIFT_H
#define PVLIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PVLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface PVMetalRenderer : NSObject <SCNSceneRendererDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC5PVLib24PVMultiCamCaptureManager")
@interface PVMultiCamCaptureManager : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@interface TextDRSView : DragRotateScaleView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
@end
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC5PVLib11TrimmerView")
@interface TrimmerView : UIView <UIScrollViewDelegate>
/// The color of the main border of the viewUIColor(red: 0.0, green: 1.0, blue: 0.7, alpha: 1.0)
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull mainColor;
/// The color of the handles on the side of the view
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull handleColor;
